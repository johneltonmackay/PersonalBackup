    ...
    function customizeGlImpact(transactionRecord, standardLines, customLines, book) {
        ...
        if (isCalculateTaxRebates){
            ...
            for (var x = 0; x < arrAdditionalLines.length; x++) {
                ...
                accountId = arrAdditionalLines[x].lineData.accountId;
                var intEntity = getEntityId(arrStdLineDet, accountId);
                isDebit = arrAdditionalLines[x].lineData.isDebit;
                amount = parseFloat(arrAdditionalLines[x].lineData.amount.toFixed(2)); // Use parseFloat to convert to a floating-point number
                ...
                if (amount >= 0.01) {
                    ...
                    if (isDebit) {
                        ...
                        totalCredit += amount;
                        customLine.setCreditAmount(amount);
                    }
                    ...
                    arrInvalidAmount.push({
                        invalidAmount: arrAdditionalLines[x].lineData.amount
                    });
                } 
            }
            ...
            if (totalDebit != totalCredit){
                if (totalDebit > totalCredit){
                    ...
                    customLine.setCreditAmount(intExcess);
